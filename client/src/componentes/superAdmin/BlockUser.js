...
const BlockUser = ({ accessToken, block, handler, cue }) => {
  ...
  const getUsersUrl =
    "https://ecommerce-deploy-production-d5e5.up.railway.app/superAdmin/getUsers";

  // ruta para bloquear y desbloquear => block === true? bloquea usuario enviado : desbloquea usuario enviado
  const postBlockedUserUrl =
    "https://ecommerce-deploy-production-d5e5.up.railway.app/superAdmin/blockUser";
